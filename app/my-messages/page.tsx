...
import { 
  MessageSquare, Send, ArrowLeft, RefreshCw, Loader2, CheckCircle2, Clock
} from 'lucide-react'
    ...
    <div className="min-h-screen bg-[#FDFBF7] text-[#0A2E1D] font-sans pb-16">
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="mb-6 flex justify-between items-center">
          ...
          {customerEmail && (
            <button onClick={() => fetchThreads(customerEmail)} className="text-xs font-bold flex items-center gap-1 text-[#0A2E1D]">
        ...
        {loading ? (
          ...
          <div className="text-center py-16 bg-white rounded-3xl border border-dashed border-gray-200 p-8 shadow-sm space-y-3">
            ...
            <Link href="/contact"><Button className="bg-[#0A2E1D] text-white text-xs font-bold rounded-full px-6">Contact Us</Button></Link>
          </div>
        ) : (
          <div className="bg-white rounded-3xl border border-gray-200 shadow-sm p-6 space-y-6">
            ...
            <div className="pt-4 border-t border-gray-100 flex gap-2">
              ...
              />
              <Button onClick={handleSendReply} disabled={sending || !replyText.trim()} className="bg-[#0A2E1D] text-white font-bold px-6 rounded-xl text-xs">
