...
export function ProductDetailModal({
  ...
  /**
   * Always return a valid integer >= 1.
   *
   * This protects the storefront from:
   * - null
   * - undefined
   * - empty values
   * - strings from Supabase
   * - 0
   * - invalid numbers
   */
  ...
  const loadProduct = async () => {
    try {
      ...
      if (data) {
        ...
        // -----------------------------------------------------
        // IMPORTANT:
        // Start the quantity at the configured MOQ.
        // -----------------------------------------------------

        const minimumQuantity =
          getMinimumOrderQuantity(data)
      ...
      console.error(
        'Error fetching product details modal:',
        err
      )
    } finally {
      setLoading(false)
  ...
  const minimumQuantity =
    getMinimumOrderQuantity(product)
  ...
  /**
   * The quantity selector can NEVER go below MOQ.
   */
  ...
  const handleRadioClick = (
    ...
    if (
      opt.has_cuts_selection ===
        true &&
      opt.allowed_cuts &&
      opt.allowed_cuts.length > 0
    ) {
      if (
        !selectedCuts[opt.name] ||
        selectedCuts[opt.name].length === 0
      ) {
        const minCount =
  ...
  const handleAddToCart = () => {
    ...
    if (quantity < minOrder) {
      ...
      setValidationError(
        `Minimum order quantity for this product is ${minOrder}.`
      )
    ...
    if (
      ...
      for (
        const group of product.customization_options
      ) {
        if (
          group.is_required &&
          (!group.type ||
                      ...
                      (
                        ...
                        return (
                          ...
                          <div
                            ...
                            className="bg-[#0A3B27] p-4 rounded-2xl border border-white/10 shadow-xs space-y-3"
                          >
                                      ...
                                      return (
                                        ...
                                        <button
                                          ...
                                          className={`p-3 rounded-xl border text-left transition cursor-pointer flex flex-col justify-between ${
                                            isSelected
                                              ? 'bg-[#EAA823] text-[#072d1d] border-[#EAA823] shadow-sm'
                                              : 'bg-[#072d1d] text-gray-200 border-white/10 hover:border-[#EAA823]/50'
                                          }`}
                                        >
                                          ...
                                          <div className="flex justify-between items-center w-full gap-2">
                                            ...
                                            <span className="text-xs font-bold flex items-center gap-1.5">
                                              ...
                                              {isSelected && (
                                                ...
                                                <span className="w-2 h-2 rounded-full bg-[#072d1d]" />
                                            ...
                                            return (
                                              ...
                                              <button
                                                ...
                                                className={`px-3 py-1.5 rounded-xl text-xs font-bold transition flex items-center gap-1.5 cursor-pointer ${
                                                  isCutSelected
                                                    ? 'bg-[#EAA823] text-[#072d1d] border border-[#EAA823] shadow-sm font-black scale-105'
                                                    : 'bg-[#0A3B27] text-gray-200 border border-white/10 hover:border-[#EAA823]'
                                                }`}
                                              >
            ...
            <div className="p-4 bg-[#041a11] border-t border-emerald-700/40 flex items-center justify-between gap-3">
              ...
              <div className="flex flex-col items-center gap-1">
                ...
                <div className="flex items-center gap-2 bg-[#072d1d] border border-white/20 rounded-xl p-1">
                  ...
                  <span className="font-bold text-xs w-7 text-center text-white">
                    {quantity}
                  </span>
